...
const styles = StyleSheet.create({
    ...
    // Kiểu dáng cho icon dấu chấm hỏi
    questionIconContainer: {
        width: 20, // Điều chỉnh kích thước hình tròn
        height: 20, // Điều chỉnh kích thước hình tròn
        backgroundColor: 'gray', // Màu nền của hình tròn
        borderRadius: 10, // Bán kính của hình tròn (width / 2)
        justifyContent: 'center',
        alignItems: 'center',
    },
    questionIcon: {
        color: 'white', // Màu của icon
        fontSize: 20, // Điều chỉnh kích thước của icon
    },
    image: {
        width: 301,
        height: 361,
    ...
    return (
        <View style={styles.container}>
            ...
            <TouchableOpacity style={styles.colorButtonContainer}>
                <Text style={styles.colorButtonText} onPress={() => navigation.navigate('ChoseColor')}>4 MÀU-CHỌN MÀU</Text>
            </TouchableOpacity>
